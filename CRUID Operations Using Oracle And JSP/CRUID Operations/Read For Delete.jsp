...
<body>
<form action="Student Information Deletion.jsp" method="post">
	<hr>
	<br>
	<center>
	...
	<br>
	<hr>
	<input type="submit" value="Delete Information" style="width: 250px;font-family: Courier New;font-size: 15px;font-weight: bold;">
	</center>
	<hr>
